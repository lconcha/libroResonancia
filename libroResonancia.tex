...
%\usepackage[dvipdfmx,pagebackref=true,colorlinks=true, linkcolor=black, pdfborderstyle={/S/U/W 0}]{hyperref}
%\usepackage[hypertex,pagebackref=true]{hyperref}
\usepackage[pagebackref=true,colorlinks=true,hidelinks,linktocpage=true]{hyperref} % this works well, convert to pdf with dvipdf 

%\addto\extrasspanish{\sisetup{locale = EN}}
